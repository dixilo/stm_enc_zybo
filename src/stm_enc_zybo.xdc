# Standard Pmod JE
set_property PACKAGE_PIN V12 [get_ports enc_in_p]
set_property PACKAGE_PIN W16 [get_ports enc_in_n]
...
set_property IOSTANDARD LVDS_25 [get_ports enc_in_p]
set_property IOSTANDARD LVDS_25 [get_ports enc_in_n]
set_property IOSTANDARD LVCMOS25 [get_ports irig_in]
