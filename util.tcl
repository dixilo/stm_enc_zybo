...
proc intc_expand { } {
    global intc_cntr
    set_property CONFIG.NUM_MI [expr $intc_cntr + 1] [get_bd_cells axi_interconnect]
}
...
proc axi_connect {p_address p_name} {
    ...
    intc_expand
    connect_bd_net -net [get_bd_nets sys_clk] [get_bd_pins axi_interconnect/${i_str}_ACLK]
    connect_bd_net -net [get_bd_nets sys_clk] ${p_intf_clock}
    connect_bd_net -net [get_bd_nets sys_resetn] [get_bd_pins axi_interconnect/${i_str}_ARESETN]
    connect_bd_net -net [get_bd_nets sys_resetn] ${p_intf_reset}
    connect_bd_intf_net [get_bd_intf_pins axi_interconnect/${i_str}_AXI] ${p_intf}
